...
class AuthService:
    ...
    async def register_user(self, user_data: dict, background_tasks: BackgroundTasks) -> dict:
        ...
        verification_token = await self.token_repo.create_verification_token(token_in)
    ...
    async def authenticate_user(self, email: str, password: str) -> Tuple[dict, str, str]:
    ...
    async def change_password(self, user_id: uuid.UUID, current_pwd: str, new_pwd: str):
    ...
    async def initiate_password_reset(self, email: str, background_tasks: BackgroundTasks):
        ...
        if user:
            ...
            reset_token = await self.token_repo.create_verification_token(token_in)
